...
public class DatabaseInitializer {
    ...
    private static void drop_tables() throws Exception {
        ...
        String dropLogUserTable = "DROP TABLE IF EXISTS UserBasic;";
        ...
        int count10 = stat.executeUpdate(dropUserTable);
    ...
    private static void create_User_table() throws Exception {
        Class.forName(JDBC_DRIVER);
        Connection con = DriverManager.getConnection(DB_URL, USER, PASS);

        String createUserBasicTable = "CREATE TABLE IF NOT EXISTS User (" +
                "userID VARCHAR(255) NOT NULL," +
                "userName VARCHAR(255) NOT NULL," +
                "userPassword VARCHAR(255) NOT NULL," +
                "PRIMARY KEY (userID)" +
